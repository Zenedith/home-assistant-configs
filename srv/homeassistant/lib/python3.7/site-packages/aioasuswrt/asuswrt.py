...
CHANGE_TIME_CACHE_DEFAULT = 60  # Default 60s
...
_RX_COMMAND = 'cat /sys/class/net/eth2.2/statistics/rx_bytes'
_TX_COMMAND = 'cat /sys/class/net/eth2.2/statistics/tx_bytes'
...
class AsusWrt:
    ...
    async def async_get_bytes_total(self, use_cache=True):
        ...
        #_LOGGER.info("Data rx: %s, tx: %s", rx, tx)
        return rx, tx
